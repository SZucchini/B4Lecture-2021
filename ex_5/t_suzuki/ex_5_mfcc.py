...
def main():
    ...
    ax[0].set_title('Spectrogram', fontsize=18)
    ax[0].set_ylabel('Frequency [Hz]')
    ax[1].set_title('MFCC sequence', fontsize=18)
    ax[1].set_ylabel('MFCC')
    ax[2].set_title(r'$\Delta$MFCC sequence', fontsize=18)
    ax[2].set_ylabel(r'$\Delta$MFCC')
    ax[3].set_title(r'$\Delta\Delta$MFCC sequence', fontsize=18)
